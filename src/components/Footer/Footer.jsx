    ...
    return(
        <footer className='footer'>
            <div class="footer-container">
                <div class="footer-parts titulo-footer">
                    <img src="./logo.png" alt=""/>
                    <p>
                        El mejor sitio para maestras jardineras.
                    </p>
                </div>
                <div class="footer-parts">
                    <p>¡Seguínos!</p>
                    <div class="footer-icons social-media">
                        <a href="https://www.instagram.com/jardines_region_4/" target="_blank" class="instagram">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 102 102" id="instagram">
                            <defs>
                ...
                <div class="footer-parts">
                    ...
                    <ul class="ul-footer">
                        ...
                        {/* aca van los links de ruta a otras paginas */}
                    </ul>
                </div>
                <div class="footer-parts">
                    <p>
                        Este sitio web fue hecho por <a href="https://github.com/ushiropaul" target="_blank" rel="noopener noreferrer">Paul Ushiro</a>
                    </p>
                    <p class="frase-footer">
                        ¡Gracias por ser parte de la comunidad de maestras jardineras de región 4!
                    </p>
                    <p class="footer-copyright">
                        © Los derechos reservados a Jardines Región 4 | 2024
                    </p>
                </div>
            </div>
        </footer>
